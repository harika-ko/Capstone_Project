import { Navbar, Nav, Form, Button, FormControl, Container, Row, Col, NavDropdown } from "react-bootstrap"
            ...
            <Row>
                <Col>
                    <Navbar expand="lg" style={{ backgroundColor: "#D8F0E6" }}>
                        <Navbar.Brand href="#home" style={{ marginLeft: "1rem" }}>FoodOra</Navbar.Brand>
